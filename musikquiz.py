...
class SongAdd(QDialog):
    def __init__(self, round_id, parent):
        ...
        self.LabelSongTitle = QLabel()
        self.LabelSongTitle.setText("Titel:")
        self.LabelSongArtist = QLabel()
        self.LabelSongArtist.setText("Interpret:")
        self.LabelSongRound = QLabel()
        self.LabelSongRound.setText("Runde:")
        self.LabelSongSeq = QLabel()
        self.LabelSongSeq.setText("Sequenz:")
        self.LabelSongPlayed = QLabel()
        self.LabelSongPlayed.setText("Gespielt:")
        self.LabelSongComment = QLabel()
        self.LabelSongComment.setText("Kommentar:")
        self.LabelSongYear = QLabel()
        self.LabelSongYear.setText("Jahr:")
        self.LabelSongCover = QLabel()
        self.LabelSongCover.setText("Cover:")

        # count songs in round for default seq value
        count_songs = procs.count_songs_by_round(round_id)

        self.songTitle = QLineEdit()
        self.songTitle.setFixedSize(400, 30)
        self.songTitle.setText("Titel")
        self.songArtist = QLineEdit()
        self.songArtist.setFixedSize(400, 30)
        self.songArtist.setText("Interpret")
        self.songRound = QLineEdit()
        self.songRound.setFixedSize(400, 30)
        self.songRound.setText(str(round_id))
        self.songSeq = QLineEdit()
        self.songSeq.setFixedSize(400, 30)
        self.songSeq.setText(str(count_songs + 1))
        self.songPlayed = QLineEdit()
        self.songPlayed.setFixedSize(400, 30)
        self.songPlayed.setText("0")
        self.songComment = QTextEdit()
        self.songComment.setFixedSize(400, 200)
        self.songComment.setTabChangesFocus(True)
        self.songComment.setText("Kommentar")
        self.songYear = QLineEdit()
        self.songYear.setFixedSize(400, 30)
        self.songYear.setText("1983")
        self.songCover = QLineEdit()
        self.songCover.setFixedSize(400, 30)
        self.songCover.setText("standard.jpg")

        self.LineSongTitle = QHBoxLayout()
        self.VLayout.addLayout(self.LineSongTitle)
        self.LineSongTitle.addWidget(
            self.LabelSongTitle, 0, Qt.AlignmentFlag.AlignRight
        )
        self.LineSongTitle.addWidget(self.songTitle, 0, Qt.AlignmentFlag.AlignLeft)

        self.LineSongArtist = QHBoxLayout()
        self.VLayout.addLayout(self.LineSongArtist)
        self.LineSongArtist.addWidget(
            self.LabelSongArtist, 0, Qt.AlignmentFlag.AlignRight
        )
        self.LineSongArtist.addWidget(self.songArtist, 0, Qt.AlignmentFlag.AlignLeft)

        self.LineSongRound = QHBoxLayout()
        self.VLayout.addLayout(self.LineSongRound)
        self.LineSongRound.addWidget(
            self.LabelSongRound, 0, Qt.AlignmentFlag.AlignRight
        )
        self.LineSongRound.addWidget(self.songRound, 0, Qt.AlignmentFlag.AlignLeft)

        self.LineSongSeq = QHBoxLayout()
        self.VLayout.addLayout(self.LineSongSeq)
        self.LineSongSeq.addWidget(self.LabelSongSeq, 0, Qt.AlignmentFlag.AlignRight)
        self.LineSongSeq.addWidget(self.songSeq, 0, Qt.AlignmentFlag.AlignLeft)

        self.LineSongPlayed = QHBoxLayout()
        self.VLayout.addLayout(self.LineSongPlayed)
        self.LineSongPlayed.addWidget(
            self.LabelSongPlayed, 0, Qt.AlignmentFlag.AlignRight
        )
        self.LineSongPlayed.addWidget(self.songPlayed, 0, Qt.AlignmentFlag.AlignLeft)

        self.LineSongComment = QHBoxLayout()
        self.VLayout.addLayout(self.LineSongComment)
        self.LineSongComment.addWidget(
            self.LabelSongComment, 0, Qt.AlignmentFlag.AlignRight
        )
        self.LineSongComment.addWidget(self.songComment, 0, Qt.AlignmentFlag.AlignLeft)

        self.LineSongYear = QHBoxLayout()
        self.VLayout.addLayout(self.LineSongYear)
        self.LineSongYear.addWidget(self.LabelSongYear, 0, Qt.AlignmentFlag.AlignRight)
        self.LineSongYear.addWidget(self.songYear, 0, Qt.AlignmentFlag.AlignLeft)

        self.LineSongCover = QHBoxLayout()
        self.VLayout.addLayout(self.LineSongCover)
        self.LineSongCover.addWidget(
            self.LabelSongCover, 0, Qt.AlignmentFlag.AlignRight
        )
        self.LineSongCover.addWidget(self.songCover, 0, Qt.AlignmentFlag.AlignLeft)

        self.ChangeButton = QPushButton()
        self.ChangeButton.setText("Hinzufügen")
        self.ChangeButton.clicked.connect(lambda: self.AddNewSong())
    ...
    def AddNewSong(self):
        procs.add_song_to_database(
            self.songTitle.text(),
            self.songArtist.text(),
            self.songRound.text(),
            self.songSeq.text(),
            self.songPlayed.text(),
            self.songComment.toPlainText(),
            self.songYear.text(),
            self.songCover.text(),
        )
...
class SongEditor(QDialog):
    def __init__(self, id, parent):
        ...
        songDetails = procs.get_song_details(id)

        self.LabelSongTitle = QLabel()
        self.LabelSongTitle.setText("Titel:")
        self.LabelSongTitle.setFixedWidth(100)
        self.LabelSongArtist = QLabel()
        self.LabelSongArtist.setText("Interpret:")
        self.LabelSongArtist.setFixedWidth(100)
        self.LabelSongRound = QLabel()
        self.LabelSongRound.setText("Runde:")
        self.LabelSongRound.setFixedWidth(100)
        self.LabelSongSeq = QLabel()
        self.LabelSongSeq.setText("Sequenz:")
        self.LabelSongSeq.setFixedWidth(100)
        self.LabelSongPlayed = QLabel()
        self.LabelSongPlayed.setText("Gespielt:")
        self.LabelSongPlayed.setFixedWidth(100)
        self.LabelSongComment = QLabel()
        self.LabelSongComment.setText("Kommentar:")
        self.LabelSongComment.setFixedWidth(100)
        self.LabelSongYear = QLabel()
        self.LabelSongYear.setText("Jahr:")
        self.LabelSongYear.setFixedWidth(100)
        self.LabelSongCover = QLabel()
        self.LabelSongCover.setText("Cover:")
        self.LabelSongCover.setFixedWidth(100)

        self.songTitle = QLineEdit()
        self.songTitle.setFixedSize(400, 30)
        self.songTitle.setText(songDetails["title"])
        self.songArtist = QLineEdit()
        self.songArtist.setFixedSize(400, 30)
        self.songArtist.setText(songDetails["artist"])
        self.songRound = QLineEdit()
        self.songRound.setFixedSize(400, 30)
        self.songRound.setText(str(songDetails["round"]))
        self.songSeq = QLineEdit()
        self.songSeq.setFixedSize(400, 30)
        self.songSeq.setText(str(songDetails["seq"]))
        self.songPlayed = QLineEdit()
        self.songPlayed.setFixedSize(400, 30)
        self.songPlayed.setText(str(songDetails["played"]))
        self.songComment = QTextEdit()
        self.songComment.setFixedSize(400, 200)
        self.songComment.setTabChangesFocus(True)
        self.songComment.setText(songDetails["comment"])
        self.songYear = QLineEdit()
        self.songYear.setFixedSize(400, 30)
        self.songYear.setText(str(songDetails["year"]))
        self.songCover = QLineEdit()
        self.songCover.setFixedSize(400, 30)
        self.songCover.setText(songDetails["cover"])
        ...
        self.ChangeButton.clicked.connect(lambda: self.changeSongDetails(id))
        self.VLayout.addWidget(self.ChangeButton)
        self.ExitButton = QPushButton()
        self.ExitButton.setText("Schließen")
        self.ExitButton.clicked.connect(self.close)
    ...
    def changeSongDetails(self, id):
        procs.change_song_details(
            id,
            self.songTitle.text(),
            self.songArtist.text(),
            self.songRound.text(),
...
class SongsWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.VLayoutSongs = QVBoxLayout(self.MainLayout)
        self.VLayoutSongs.setContentsMargins(10, 10, 10, 10)
        self.VLayoutSongs.setSpacing(6)
        self.VLayoutSongs.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.MainLayout.setLayout(self.VLayoutSongs)

        self.HLayoutMenu = QHBoxLayout()

        self.SongEditRoundId = 0
        self.pBSongsRound1 = QPushButton()
        self.pBSongsRound1.setText(round_1_name)
        self.pBSongsRound1.clicked.connect(lambda: self.GetSongs(1))
        self.pBSongsRound1.clicked.connect(lambda: setMyRoundId(1))
        self.HLayoutMenu.addWidget(self.pBSongsRound1)
        self.pBSongsRound2 = QPushButton()
        self.pBSongsRound2.setText(round_2_name)
        self.pBSongsRound2.clicked.connect(lambda: self.GetSongs(2))
        self.pBSongsRound2.clicked.connect(lambda: setMyRoundId(2))
        self.HLayoutMenu.addWidget(self.pBSongsRound2)
        self.pBSongsRound3 = QPushButton()
        self.pBSongsRound3.setText(round_3_name)
        self.pBSongsRound3.clicked.connect(lambda: self.GetSongs(3))
        self.pBSongsRound3.clicked.connect(lambda: setMyRoundId(3))
        self.HLayoutMenu.addWidget(self.pBSongsRound3)
        self.pBSongsRound4 = QPushButton()
        self.pBSongsRound4.setText(round_4_name)
        self.pBSongsRound4.clicked.connect(lambda: self.GetSongs(4))
        self.pBSongsRound4.clicked.connect(lambda: setMyRoundId(4))
        self.HLayoutMenu.addWidget(self.pBSongsRound4)
        self.pBSongsRound5 = QPushButton()
        self.pBSongsRound5.setText(round_5_name)
        self.pBSongsRound5.clicked.connect(lambda: self.GetSongs(5))
        self.pBSongsRound5.clicked.connect(lambda: setMyRoundId(5))
        self.HLayoutMenu.addWidget(self.pBSongsRound5)
        self.pBSongsRound6 = QPushButton()
        self.pBSongsRound6.setText(round_6_name)
        self.pBSongsRound6.clicked.connect(lambda: self.GetSongs(6))
        self.pBSongsRound6.clicked.connect(lambda: setMyRoundId(6))
        self.HLayoutMenu.addWidget(self.pBSongsRound6)
        self.pBSongsRound7 = QPushButton()
        self.pBSongsRound7.setText(round_7_name)
        self.pBSongsRound7.clicked.connect(lambda: self.GetSongs(7))
        self.pBSongsRound7.clicked.connect(lambda: setMyRoundId(7))
        self.HLayoutMenu.addWidget(self.pBSongsRound7)

        def setMyRoundId(round_id):
            self.SongEditRoundId = round_id

        self.TopTitle = QLabel()
        self.TopTitle.setText("Songs")
        self.TopTitle.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.TopTitle.setFont(self.FontTop)

        self.VLayoutSongs.addWidget(self.TopTitle)

        self.MainLayout = QWidget(self)
        self.MainLayout.setObjectName("MainLayout")

        self.SongList = QListWidget(self.MainLayout)
        self.SongList.setAlternatingRowColors(True)
        self.SongList.setDragDropMode(QAbstractItemView.InternalMove)

        self.SongList.itemDoubleClicked.connect(
            lambda: self.EditSong(self.SongList.currentItem())
        )

        self.VLayoutSongs.addLayout(self.HLayoutMenu)
        self.VLayoutSongs.addWidget(self.SongList)

        self.HLayoutButtons = QHBoxLayout()
        self.VLayoutSongs.addLayout(self.HLayoutButtons)

        self.AddSongButton = QPushButton()
        self.AddSongButton.setFixedSize(180, 30)
        self.AddSongButton.setText("Song hinzufügen")
        self.AddSongButton.clicked.connect(lambda: self.AddSong(self.SongEditRoundId))
        self.RemoveSongButton = QPushButton()
        self.RemoveSongButton.setFixedSize(180, 30)
        self.RemoveSongButton.setText("Song löschen")
        self.RemoveSongButton.clicked.connect(self.RemoveSong)
        self.RemoveSongButton.clicked.connect(
            lambda: self.GetSongs(self.SongEditRoundId)
        )
        ...
        self.ExitButton.setText("Schließen")
        self.ExitButton.clicked.connect(self.closeSongsWindow)
        self.HLayoutButtons.addWidget(self.AddSongButton)
        self.HLayoutButtons.addWidget(self.RemoveSongButton)
        self.HLayoutButtons.addWidget(self.ChangeOrderButton)
        self.HLayoutButtons.addWidget(self.ExitButton)

        self.SongEditRoundId = 1

        # self.GetSongsTimer = QTimer()
        # self.GetSongsTimer.timeout.connect(lambda: self.GetSongs(self.SongEditRoundId))
        # self.GetSongsTimer.start(2000)

        self.GetSongs(self.SongEditRoundId)

    def GetSongs(self, round_id):
        # print(f"GetSongTimer ISACTIVE: {self.GetSongsTimer.isActive()}")
        print(f"----- GET SONGS ROUND {round_id} -----")
        self.SongList.clear()
        songs = procs.get_songs_for_round(round_id)
        for song in songs:
    ...
    def RemoveSong(self):
        print("----- REMOVE SONG -----")
        listItems = self.SongList.selectedItems()
        if not listItems:
            return
        for item in listItems:
            self.SongList.takeItem(self.SongList.row(item))
            # print(f"removed song: ID {item.data(Qt.UserRole)}")
            procs.remove_song_from_database(item.data(Qt.UserRole))
    ...
    def SaveChangedOrder(self):
        ...
        for i in range(self.SongList.count()):
            ...
            seq = i + 1
            # print(f"changed song sequence: ID {item.data(Qt.UserRole)} - SEQ {seq}")
            procs.change_song_seq(item.data(Qt.UserRole), seq)

    def EditSong(self, item):
        SongId = item.data(Qt.UserRole)
        pop = SongEditor(SongId, self)
        pop.show()

    def AddSong(self, round_id):
        pop = SongAdd(round_id, self)
        pop.show()

    def closeSongsWindow(self):
        print("----- CLOSE SONGS WINDOW -----")
        # self.GetSongsTimer.stop()
        self.close()
...
class SettingsWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.FindDoubleSongsButton = QPushButton()
        self.FindDoubleSongsButton.setText("Doppelte Songs finden")
        self.FindDoubleSongsButton.clicked.connect(self.FindDoubleSongs)
        ...
        self.VLayoutStatistics.addWidget(self.FindDoubleSongsButton)
    ...
    def FindDoubleSongs(self):
        print("----- FIND DOUBLE SONGS -----")
        doubleSongs = procs.find_double_songs()
        for song in doubleSongs:
            print(f"Song: {song}, Anzahl: {doubleSongs[song]}")
        dlg = QMessageBox(self)
        dlg.setWindowTitle("Doppelte Songs gefunden!")
        dlg.setText(f"Es wurden {len(doubleSongs)} doppelte Songs gefunden!\n{doubleSongs}")
...
class GameWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.pBSkipSongQuiz = QPushButton(self.verticalLayoutWidget)
        self.pBSkipSongQuiz.setObjectName("pBSkipSongQuiz")
        self.pBSkipSongQuiz.setMinimumSize(QSize(0, 40))
        self.pBSkipSongQuiz.setMaximumSize(QSize(250, 16777215))
        self.pBSkipSongQuiz.setFont(font2)
        self.pBSkipSongQuiz.clicked.connect(lambda: self.answer(1, "skip"))
        self.pBSkipSongQuiz.clicked.connect(self.initGame)
        self.GridScoreLayout.addWidget(self.pBSkipSongQuiz, 5, 2, 1, 1)
        ...
        self.HLayoutNextSongInfo = QHBoxLayout()

        nextSongCover = cover_path + "standard.jpg"
        self.nextSongCoverPixmap = QPixmap(nextSongCover)
        self.nextSongCoverPixmap = self.nextSongCoverPixmap.scaled(small_cover)
        self.nextSongCover = QLabel(self)
        self.nextSongCover.setPixmap(self.nextSongCoverPixmap)

        self.nextSongInfo = QVBoxLayout()

        self.NextSongLabelTop = QLabel(self)
        self.NextSongLabelTop.setText("Nächster Song:")
        self.NextSongLabelTop.setFont(font2)
        self.NextSongLabelTop.setFixedSize(600, 30)
        self.NextSongLabelTitle = QLabel(self)
        self.NextSongLabelTitle.setText("Titel")
        self.NextSongLabelTitle.setFont(font2)
        self.NextSongLabelTitle.setFixedSize(600, 30)
        self.NextSongLabelComment = QPlainTextEdit()
        self.NextSongLabelComment.setStyleSheet("font-size: 20px;")
        self.NextSongLabelComment.setFixedWidth(600)

        self.nextSongInfo.addWidget(
            self.NextSongLabelTop, 0, Qt.AlignmentFlag.AlignCenter
        )
        self.nextSongInfo.addWidget(
            self.NextSongLabelTitle, 0, Qt.AlignmentFlag.AlignCenter
        )
        self.nextSongInfo.addWidget(
            self.NextSongLabelComment, 0, Qt.AlignmentFlag.AlignCenter
        )

        self.HLayoutNextSongInfo.addLayout(self.nextSongInfo)
        self.HLayoutNextSongInfo.addWidget(self.nextSongCover)
        self.HLayoutNextSongInfo.setAlignment(Qt.AlignmentFlag.AlignHCenter)
        self.VLayoutMain.addLayout(self.HLayoutNextSongInfo)
        ...
        previousSongCover = cover_path + "standard.jpg"
        self.previousSongCoverPixmap = QPixmap(previousSongCover)
        self.nextSongCoverPixmap = self.nextSongCoverPixmap.scaled(small_cover)
        self.previousSongCover = QLabel(self)
        self.previousSongCover.setPixmap(self.previousSongCoverPixmap)

        self.PreviousSongInfo = QVBoxLayout()

        self.PreviousSongLabelTop = QLabel(self)
        self.PreviousSongLabelTop.setText("Vorheriger Song:")
        self.PreviousSongLabelTop.setFont(font2)
        self.PreviousSongLabelTop.setFixedSize(600, 30)
        self.PreviousSongLabelTitle = QLabel(self)
        self.PreviousSongLabelTitle.setText("Titel")
        self.PreviousSongLabelTitle.setFont(font2)
        self.PreviousSongLabelTitle.setFixedSize(600, 30)
        self.PreviousSongLabelComment = QPlainTextEdit()
        self.PreviousSongLabelComment.setStyleSheet("font-size: 20px;")
        self.PreviousSongLabelComment.setFixedWidth(600)

        self.PreviousSongInfo.addWidget(
            self.PreviousSongLabelTop, 0, Qt.AlignmentFlag.AlignCenter
        )
        self.PreviousSongInfo.addWidget(
            self.PreviousSongLabelTitle, 0, Qt.AlignmentFlag.AlignCenter
        )
        self.PreviousSongInfo.addWidget(
            self.PreviousSongLabelComment, 0, Qt.AlignmentFlag.AlignCenter
        )

        self.HLayoutPreviousSongInfo = QHBoxLayout()
        self.HLayoutPreviousSongInfo.setObjectName("HLayoutPreviousSongInfo")

        self.HLayoutPreviousSongInfo.addLayout(self.PreviousSongInfo)
        self.HLayoutPreviousSongInfo.addWidget(
            self.previousSongCover, 0, Qt.AlignmentFlag.AlignCenter
        )
        self.HLayoutPreviousSongInfo.setAlignment(Qt.AlignmentFlag.AlignHCenter)
        self.VLayoutMain.addLayout(self.HLayoutPreviousSongInfo)
    ...
    def answer(self, player_id, answer):
        ...
        next_song = {}
        next_song = procs.get_next_song(my_round_id)
        procs.set_last_song(
            next_song["title"],
            next_song["artist"],
            next_song["year"],
        ...
        procs.mark_song_as_played(my_round_id)
    ...
    def initGame(self):
        ...
        previous_song = {}
        previous_song = procs.get_last_song()
        maximum_songs = procs.get_round_maximum_songs(my_round_id)
        songsToPlay = maximum_songs - next_song.get("seq", 0) + 1
        song_count = (
            f"SONG# {next_song.get('seq',0)} / {maximum_songs} (noch {songsToPlay}) "
        )
        ...
        self.pBQuizControls.setText(song_count)
        if songsToPlay < 6:
            self.pBQuizControls.setStyleSheet("color: rgb(255, 0, 0);")
        else:
            self.pBQuizControls.setStyleSheet("color: rgb(249, 240, 107);")
        self.pBTikTak.setText("\u23f2 - ticking")
        self.pBSkipSongQuiz.setText("skip song")
        self.pBResetBuzzer.setText("reset buzzer")

        self.NextSongLabelTitle.setText(
            f"{next_song['title']} - {next_song['artist']} ({next_song['year']})"
        )
        self.NextSongLabelComment.setPlainText(next_song["comment"])
        nextSongCover = next_song["cover"]
        nextSongCover = "".join(cover_path + nextSongCover)
        self.nextSongCoverPixmap = QPixmap(nextSongCover)
        self.nextSongCoverPixmap = self.nextSongCoverPixmap.scaled(small_cover)
        self.nextSongCover.setPixmap(self.nextSongCoverPixmap)
        ...
        self.PreviousSongLabelTitle.setText(
            f"{previous_song['title']} - {previous_song['artist']} ({previous_song['year']})"
        )
        self.PreviousSongLabelComment.setPlainText(previous_song["comment"])
        previousSongCover = previous_song["cover"]
        previousSongCover = "".join(cover_path + previousSongCover)
        self.previousSongCoverPixmap = QPixmap(previousSongCover)
        self.previousSongCoverPixmap = self.previousSongCoverPixmap.scaled(small_cover)
        self.previousSongCover.setPixmap(self.previousSongCoverPixmap)
    ...
    def get_spotify_playing_song(self):
        # print("----- GET SPOTIFY PLAYING SONG -----")
        spotify_song, spotify_artist = procs.get_song_infos()
        self.currentSpotifySong.setText(
            f"Spotify Song: {spotify_song} - {spotify_artist}"
        )
...
class MusikQuiz(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.pBSongs = QPushButton("Songs", self)
        self.pBSongs.setFixedSize(200, 30)
        self.pBSongs.clicked.connect(self.Songs)
        ...
        MainLayout.addWidget(self.pBSongs, alignment=Qt.AlignmentFlag.AlignCenter)
