...
class GameWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.NextQuestionLabelTitle.setFixedSize(600, 60)
    ...
    def initGame(self):
        ...
        if no_questions == 0:
            ...
            self.pBPlayer1Correct.setStyleSheet("background-color: rgb(0, 255, 0);")
            self.pBPlayer1Wrong.setEnabled(True)
            self.pBPlayer1Wrong.setStyleSheet("background-color: rgb(255, 0, 0);")
            self.pBPlayer2Correct.setEnabled(True)
            self.pBPlayer2Correct.setStyleSheet("background-color: rgb(0, 255, 0);")
            self.pBPlayer2Wrong.setEnabled(True)
            self.pBPlayer2Wrong.setStyleSheet("background-color: rgb(255, 0, 0);")
            self.pBPlayer3Correct.setEnabled(True)
            self.pBPlayer3Correct.setStyleSheet("background-color: rgb(0, 255, 0);")
            self.pBPlayer3Wrong.setEnabled(True)
            self.pBPlayer3Wrong.setStyleSheet("background-color: rgb(255, 0, 0);")
            self.pBPlayer4Correct.setEnabled(True)
            self.pBPlayer4Correct.setStyleSheet("background-color: rgb(0, 255, 0);")
            self.pBPlayer4Wrong.setEnabled(True)
            self.pBPlayer4Wrong.setStyleSheet("background-color: rgb(255, 0, 0);")
