...
(24,'Welche Gesetze und Verordnungen werden durch $38 StVO NICHT ausser Kraft gesetzt? ','StVG, StVZO, StGB, ',2,9,0,NULL),
...
(34,'Unter Normaldruck entsteht beim Verdampfen von einem Liter Wasser wie viel Wasserdampf?','1700',3,4,0,NULL),
...
(39,'Was regelt §38 StVO?','Blaues Blinklicht und gelbes Blinklicht (Wegerecht)',3,9,0,NULL),
...
(47,'Was bedeutet der FMS Status 3?','Einsatz übernommen / Anfahrt zum Einsatzort',4,2,0,NULL),
...
(52,'In welchem Bereich liegt die Verschäumungszahl von Leichtschaum?','200 - 1000',4,7,0,NULL),
...
(71,'Nenne die Luftverzleichszahl von Chlorwasserstoff','37',5,11,0,NULL),
...
(87,'Wie ist die Rettungshöhe der 4-teiligen Steckleiter bei 2 Teilen?','3,7m',6,7,0,NULL),
...
(90,'Welche Dienstvorschrift regelt den Sprechfunkverkehr?','FwDV / DV 810',6,10,0,NULL),
...
(93,'Was unfasst Gefahrgutklasse 5?','Entzündend wirkende Stoffe',6,13,0,NULL),
(94,'Welche Brände werden der Brandklasse A zugeordnet?','Brände fester Stoffe, haupsächlich organischer Natur, die normalerweise unter Glutbildung verbrennen z.B. Holz, Papier, Stroh, Textilien, Kohle, Autoreifen',6,14,0,NULL),
...
(101,'Welche Betriebsarten gibt es im Digitalfunk?','TMO, DMO',7,1,0,NULL),
...
(103,'Wie ist die Rettungshöhe der 4-teiligen Steckleiter?','7,2m',7,3,0,NULL),
(104,'Durch eine Lose Rolle wird die mögliche Last…','…verdoppelt.',7,4,0,NULL),
(105,'Wie setzt sich normalerweise die Ungebungsluft zusammen?','N 78%, O 21%, Edelgase < 1%, CO2 0,03 %',7,5,0,NULL),
...
(117,'Welchen FMS Status setze ich beim übernehmen des Einsatzes bzw. verlassen des Gerätehauses mit Einsatzauftrag?','Status 3',7,17,0,NULL),
...
-- Dump completed on 2024-09-26 15:39:21
